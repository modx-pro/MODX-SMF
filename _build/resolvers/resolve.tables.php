...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('smf_core_path', null, $modx->getOption('core_path') . 'components/smf/') . 'model/';
            $modx->addPackage('smf', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/smf/model/schema/smf.mysql.schema.xml';
